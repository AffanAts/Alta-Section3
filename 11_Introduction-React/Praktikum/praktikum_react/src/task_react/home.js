...
import photo from "../asset/img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg";
        ...
        <div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-8 col-md-12 col-sm-12 col-12">
                  <div className="alterra">
                    <a href="index.html"><img className="logo-atas" alt="Alterra" src={logoAlta} /></a>
                  </div>
                </div>
                <div className="col-lg-4 col-md-12 col-sm-12 col-12">
                  ...
                  <div className="row align-items-center navig">
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-3 text-md-center text-sm-center text-lg-left"><a href="x.html">EXPERIENCE</a></div>
          ...
          <div className="container h-100">
            <div className="row align-items-center isi-home">
              <div className="col-lg-4 col-md-12 col-sm-12  col-12">
                <img id="foto-profil" src={photo} alt="profil" />
              </div>
              <div className="col-lg-8 col-md-12 col-sm-12 col-12">
